        ...
        <Container>
          <Row>
            <Col>
              <Card className="mt-5">
                <Card.Body>
                  <Card.Title>Nadi Furkan Açıkgöz</Card.Title>
                  <Card.Text className='mt-4'>
                    Ev arayan var mı ? Şurda burda kalıyorum ama ev arkadaşı lazım ev arkadaşı arayan gelsin hemen 
                  </Card.Text>
                  ...
                  <div className='mt-4'>
                    <Button variant="primary">Send message to Furkan</Button>
                  </div>
                </Card.Body>
